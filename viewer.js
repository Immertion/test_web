...
export default {
	...
	createRenderer(setting){
		...
		this.renderer = new THREE.WebGLRenderer(setting);

		setting.parent.appendChild(this.renderer.domElement);

		if (setting.clearColor)this.renderer.setClearColor(setting.clearColor);
		
		
		this.renderer.setSize(
			setting.parent.offsetWidth,
			setting.parent.offsetHeight);
